...
export default function HomePage() {
    ...
    useEffect(()=>{
        const fetchEvents = async () => {
            try {
                ...
                setRandomEvents(getRandomItems(data.data, 5));
            } catch (error) {
    ...
    return(
        <>
            <section>
                <Navbar />
                <div className=" dark:bg-navy bg-blue py-20 px-50 text-center w-full h-1/2 font-pop flex flex-col">
                    ...
                    <div className="animate-appear2 font-mont">
                        <Link to={"/register"} className="hover:text-blue hover:border-white hover:bg-white px-10 py-2 cursor-pointer text-white border-1 border-white rounded-2xl">Start Now!</Link>
                    </div>
                ...
                <div className=" dark:bg-gray-800 py-5 px-20 w-full h-1/2 font-pop flex flex-col">
